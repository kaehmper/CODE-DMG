...
{
    [Info("GameBoyEmulatorPlugin", "kaehmper", "0.2.0")]
    [Description("In-game GameBoy (DMG) emulator using CODE-DMG core with FULL CPU implementation, exposed via Carbon commands + UI overlay (no Raylib).")]
    ...
    // CPU class with FULL INSTRUCTION SET (all ~500 opcodes)
